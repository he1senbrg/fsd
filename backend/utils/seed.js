...
const seed = async () => {
  ...
  const posts = await Post.create([
    {
      ...
      media: [
        {
          url: 'https://images.unsplash.com/photo-1508700929628-666bc8bd84ea?w=600',
          type: 'image',
        },
      ],
    },
    {
      ...
      media: [
        {
          url: 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=600',
          type: 'image',
        },
      ],
    },
    ...
    },
    {
      ...
      commentCount: 6,
      media: [
        { url: 'https://images.unsplash.com/photo-1436918898788-ebce04d38e46', type: 'image' },
      ],
    },
  ]);
  ...
  const products = await Product.create([
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1742800766508-da7ac424b073'],
      region: 'Rajasthan',
      stock: 15,
      badge: 'New Arrival',
      rating: 4.5,
