    ...
    const events = await Event.create([
        {
            ...
            venue: 'Kamani Auditorium, New Delhi', eventType: 'paid',
            price: 500, totalQty: 200, soldQty: 45,
        ...
        },
        {
            ...
            venue: 'Kalakshetra, Chennai', eventType: 'paid',
            price: 3000, totalQty: 30, soldQty: 18,
        ...
        },
        {
            ...
            startDate: new Date('2026-03-25'), endDate: new Date('2026-03-25'),
            venue: 'Jawahar Kala Kendra, Jaipur',
            eventType: 'free', status: 'published',
