  ...
  if (success) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-6 py-16 text-center">
        ...
        <div>
          <h2 className="text-3xl font-bold text-[var(--text-primary)] font-display mb-2">
            Payment Successful!
          </h2>
    ...
    <div className="max-w-4xl mx-auto py-2">
      ...
      <div className="flex flex-wrap gap-4 mb-8">
        {[
          ...
          <div
            key={b.label}
            className="flex items-center gap-2 bg-white border border-stone-100 rounded-full px-4 py-1.5 text-xs text-stone-500 shadow-sm"
          >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-orange-100 p-6">
            ...
            {paymentMethod === 'card' && (
              <div className="space-y-4">
                <div className="p-3 bg-blue-50 border border-blue-100 rounded-lg text-xs text-blue-700 flex items-center gap-2">
                  <span className="material-symbols-outlined text-sm">info</span>
                  Test mode — use card{' '}
                  <span className="font-mono font-bold">4242 4242 4242 4242</span>, any future
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <span className="material-symbols-outlined absolute right-3 top-3 text-stone-300">
                      credit_card
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-[var(--deep-teal)] to-[var(--primary-color)] rounded-2xl p-5 text-white relative overflow-hidden mt-2">
                  ...
                  <p className="text-xs opacity-70 mb-4 font-medium tracking-widest uppercase">
                    Debit / Credit Card
                  </p>
            ...
            {paymentMethod === 'upi' && (
              <div className="space-y-4">
                <div className="p-3 bg-blue-50 border border-blue-100 rounded-lg text-xs text-blue-700 flex items-center gap-2">
                  <span className="material-symbols-outlined text-sm">info</span>
                  Test mode — enter any valid UPI ID format like{' '}
                  <span className="font-mono font-bold">test@upi</span>
                </div>
                <div>
                  <label className="text-sm font-semibold text-[var(--text-primary)] mb-1.5 block">
                    UPI ID *
                ...
                <div className="grid grid-cols-4 gap-3 pt-2">
                  {['GPay', 'PhonePe', 'Paytm', 'BHIM'].map((app) => (
                    <Button
                      key={app}
                      onClick={() => setUpiId(`test@${app.toLowerCase()}`)}
                      className="flex flex-col items-center gap-1.5 py-3 rounded-xl border border-stone-200 hover:border-[var(--primary-color)] hover:bg-orange-50 transition-colors text-xs font-medium text-stone-600"
                    >
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <input
                  ...
                  className="border border-stone-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[var(--secondary-color)] focus:border-transparent"
                />
                <input
          ...
          <div className="bg-white rounded-xl shadow-sm border border-orange-100 p-6 sticky top-20">
              ...
              <div className="space-y-3 mb-4">
                {cartLoading ? (
                  <div className="flex items-center justify-center py-4">
                    <span className="material-symbols-outlined animate-spin text-[var(--secondary-color)]">
                      progress_activity
                    </span>
                  </div>
                ) : cartItems.length === 0 ? (
              ...
              <div className="bg-orange-50 rounded-xl p-4 mb-4">
                ...
                {tierName && (
                  <p className="text-xs text-stone-500 mb-1">
                    Ticket Tier: <span className="font-semibold">{tierName}</span>
                  </p>
                )}
            ...
            <div className="mt-4 flex items-center justify-center gap-3 flex-wrap">
              {['Visa', 'Mastercard', 'RuPay', 'UPI', 'BHIM'].map((brand) => (
                <span
                  key={brand}
                  className="text-[10px] font-bold text-stone-400 border border-stone-200 px-2 py-1 rounded"
                >
                  {brand}
                </span>
              ))}
