...
export const postAPI = {
  ...
  sharePost: (id) => request(`/posts/${id}/share`, { method: 'POST' }),
...
export const opportunityAPI = {
  ...
  toggleBookmark: (id) => request(`/opportunities/${id}/bookmark`, { method: 'POST' }),
...
export const userAPI = {
  ...
  updateCover: (formData) => request('/users/me/cover', { method: 'PUT', body: formData }),
  updateProfile: (data) =>
