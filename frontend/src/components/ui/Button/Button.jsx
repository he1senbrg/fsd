...
const BASE_CLASS = "transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--secondary-color)] focus-visible:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed";
...
export default function Button({
    ...
    return (
        ...
        >
            {loading ? (
                <span className="material-symbols-outlined animate-spin text-[1.1em]">progress_activity</span>
            ) : null}
            {!loading && leadingIcon ? (
